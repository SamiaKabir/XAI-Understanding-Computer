 ...
 if(doc_num<=20)
    {
     if(accuracy==2)
     {
          if(doc_num==2 || doc_num==3 || doc_num==4 || doc_num==9 || doc_num==12 || doc_num==15 ||doc_num==18 || doc_num==19  ){
    ...
    if(accuracy==2)
     {
          if(doc_num==23 || doc_num==25 || doc_num==27 || doc_num==29 || doc_num==30 || doc_num==34 || doc_num==35 || doc_num==36 || doc_num==37 || doc_num==38){
          	       label_title.text("Computer Answer:  Cat");
          }
