...
function image_title(){
    ...
    explanation_title.text("Please rate how confident you are about the Artificial Intelligence's accuracy in identifying the object in this image: ( "+ doc_num+" / "+total_doc+ " )");
}
